...
#include "RaceAIWheelFront.h"
#include "RaceAIWheelRear.h"
#include "RaceAIHud.h"
...
const FName ARaceAIPawn::LookUpBinding("LookUp");
const FName ARaceAIPawn::LookRightBinding("LookRight");
const FName ARaceAIPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

ARaceAIPawn::ARaceAIPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = URaceAIWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = URaceAIWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = URaceAIWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = URaceAIWheelRear::StaticClass();
...
void ARaceAIPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ARaceAIPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ARaceAIPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ARaceAIPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ARaceAIPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ARaceAIPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ARaceAIPawn::OnResetVR); 
}
...
void ARaceAIPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ARaceAIPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ARaceAIPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ARaceAIPawn::EnableIncarView(const bool bState)
{
...
void ARaceAIPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ARaceAIPawn::UpdateHUDStrings()
{
...
void ARaceAIPawn::SetupInCarHUD()
{
...
void ARaceAIPawn::UpdatePhysicsMaterial()
{
